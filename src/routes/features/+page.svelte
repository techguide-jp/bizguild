<script lang="ts">
	...
	const ownerFaqs = [
		...
		},
		{
			...
			answer:
				'はい、設定可能です。ただし、まずは無料でメンバーを集め、コミュニティが活性化してから会費を検討することを推奨しています。'
		},
		{
			question: '紹介手数料の割合は変更できますか？',
			answer: 'はい、コミュニティの性質に合わせて5%〜15%の範囲で設定可能です。'
		},
		{
			question: '開発パートナー契約後、追加費用は発生しますか？',
			answer:
				'開発期間中の追加費用はありません。正式リリース後は月額2.5万円（永久50%OFF）のみです。'
		},
		{
			question: '途中で解約できますか？',
			answer:
				'開発パートナー契約は、開発完了までの協力が前提となります。正式リリース後は、1ヶ月前の通知で解約可能です。'
		}
	];
