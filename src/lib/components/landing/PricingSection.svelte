					...
					<div class="grid gap-4 sm:grid-cols-3">
						...
						>
							...
							<div class="space-y-2 text-sm">
								...
								<div class="flex items-center justify-between">
									...
									<span class="font-medium text-primary">{formatPriceYen(fixedOwnerAmount)}</span>
								</div>
						...
						<div
							class="rounded-lg border bg-background p-4 {selectedPlan === 'revenue'
								...
								: ''}"
						>
							<p class="mb-3 text-center text-sm font-semibold text-primary">レベニューシェア</p>
							<div class="space-y-2 text-sm">
								<div class="flex items-center justify-between">
									<span class="flex items-center gap-1.5">
										<Users class="h-3.5 w-3.5" />
								...
								<div class="flex items-center justify-between">
									...
									<span class="font-medium text-primary">{formatPriceYen(revenueOwnerAmount)}</span>
								</div>
								<div class="flex items-center justify-between">
									<span class="flex items-center gap-1.5">
										<Rocket class="h-3.5 w-3.5" />
						...
						>
							...
							<div class="space-y-2 text-sm">
								...
								<div class="flex items-center justify-between">
									...
									<span class="font-medium text-primary">{formatPriceYen(monthlyOwnerAmount)}</span>
								</div>
								<div class="flex items-center justify-between">
									<span class="flex items-center gap-1.5">
										<Rocket class="h-3.5 w-3.5" />
										...
										<div class="space-y-1">
											<div
												class="{revenueMonthlyProfit >= 0
													...
													: 'text-destructive'} font-semibold"
											>
												{revenueMonthlyProfit >= 0 ? '+' : ''}{formatPriceYen(revenueMonthlyProfit)}
											</div>
										...
										<div class="space-y-1">
											<div
												class="{monthlyMonthlyProfit >= 0
													...
													: 'text-destructive'} font-semibold"
											>
												{monthlyMonthlyProfit >= 0 ? '+' : ''}{formatPriceYen(monthlyMonthlyProfit)}
											</div>
											<div class="text-xs text-muted-foreground">
				...
				<div class="mt-6 rounded-lg bg-muted/50 p-4">
					<div class="space-y-2 text-xs text-muted-foreground">
						...
						<ul class="ml-4 list-disc space-y-1">
							...
							<li>リリース後6ヶ月目以降の月額費用を考慮（固定費プランのみ1〜5ヶ月目は月額0円）</li>
						</ul>
					</div>
				</div>
			</div>
